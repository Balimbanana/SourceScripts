...
if EXIST "%linkdir%\steamapps\workshop\content\17520\729355384\upload.vpk" set pmpck3=1
if EXIST "%linkdir%\steamapps\workshop\content\17520\1099811040\m_pack4upd.vpk" set pmpck4=1
...
if '%pmpck3%'=='1' echo Player Model Pack 3 detected in Steam workshop dir.
if '%pmpck4%'=='1' echo Player Model Pack 4 detected in Steam workshop dir.
...
if '%pmpck3%'=='2' echo Player Model Pack 3 installed.
if '%pmpck4%'=='2' echo Player Model Pack 4 installed.
...
if %pmpck3% LEQ 1 echo (3) To install Pack 3 to your client (For 56.16).
if %pmpck4% LEQ 1 echo (4) To install Pack 4 to your client (For 56.16).
...
if '%pmpckopt%'=='3' (
	if '%pmpck3%'=='1' (
		set pmpckdir=^%linkdir%\steamapps\workshop\content\17520\729355384
		set pmpckid=^729355384
		set part=^3
		set installing=^1
	) else echo ^Already installed.
)
if '%pmpckopt%'=='4' (
	if '%pmpck4%'=='1' (
		set pmpckdir=^%linkdir%\steamapps\workshop\content\17520\1099811040
		set pmpckid=^1099811040
		set part=^4
		set installing=^1
	) else echo ^Already installed.
)
